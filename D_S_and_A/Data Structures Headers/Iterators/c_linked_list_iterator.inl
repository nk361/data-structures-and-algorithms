...
{
	c_linked_list_iterator<ValType, NodeType> temp = *this; current = &(*current)->children[0]; return temp;
}
...
template <class ValType, template<class> class NodeType>
NodeType<ValType> * * c_linked_list_iterator<ValType, NodeType>::operator*() { return current; }